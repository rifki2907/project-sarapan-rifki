    ...
    <div class="d-flex aligns-items-center justify-content-center">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                <body class="hold-transition login-page" style="background-image: url('7.jpg'); background-repeat: no-repeat; background-size: cover;"> 
                    ...
                    <form wire:submit.prevent="store" method="POST">
                        ...
                        <div class=" card-body">
                            ...
                            <div class="form-group">
                                <label for="sarapan_id">Sarapan</label>
                                <select class="form-control" wire:model="sarapan_id" name="sarapan_id">
                                    <option hidden>--Pilih Sarapan--</option>
                                    @foreach($dataSarapan as $dt )
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-danger" wire:click="delete({{ $dt->id }})"><i class="fas fa-trash"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

...
<div class="col-md-4"> 
    ...
    <div class="card card-success"> 
        <div class="card-header"> 
            <h3 class="card-title">Input Users</h3> 
        </div> 
        <!-- /.card-header --> 
        <!-- form start --> 
        <form action="{{ route('pengguna.store') }}" method="POST"> 
            ...
            <div class=" card-body"> 
                ...
                <div class="form-group"> 
                    ...
                    <input type="email" class="form-control @error('email') isinvalid @enderror" id="email" name="email" placeholder="JohnDoe@example.com" required > 
                    @error('email') 
